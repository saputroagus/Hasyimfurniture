...
class CreateWoodsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Woods", 'woods', 'nama_kayu', 'fa-cube', [
            ["nama_kayu", "Nama Kayu", "String", false, "", 0, 256, false],
            ["jenis_kayu", "Jenis Kayu", "String", false, "", 0, 256, false],
        ]);
