...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $promo_product->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Promo_Products", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/promo_products/'.$promo_product->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Promo_Products", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.promo_products.destroy', $promo_product->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/promo_products') }}" data-toggle="tooltip" data-placement="right" title="Back to Promo Products"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'kode_barangpromo')
						@la_display($module, 'kode_promo')
						@la_display($module, 'kode_barang')
						@la_display($module, 'harga_potongan')
					</div>
				</div>
			</div>
		</div>
