...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $value->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Values", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/values/'.$value->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Values", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.values.destroy', $value->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/values') }}" data-toggle="tooltip" data-placement="right" title="Back to Values"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'total_terjual')
						@la_display($module, 'bulan')
						@la_display($module, 'tahun')
						@la_display($module, 'hasil_ramalan')
					</div>
				</div>
			</div>
		</div>
